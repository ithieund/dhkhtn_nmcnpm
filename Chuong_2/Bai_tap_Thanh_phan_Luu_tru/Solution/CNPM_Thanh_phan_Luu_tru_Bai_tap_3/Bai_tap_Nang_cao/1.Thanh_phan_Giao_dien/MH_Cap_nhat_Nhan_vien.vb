...
#Region "Biến/Đối tượng toàn cục"
    ...
    Dim Da_chon_Nhan_vien As Boolean = False
#End Region
...
#Region "Xử lý Khởi động"
    ...
    Sub Khoi_dong()
        ...
        AddHandler Th_Chon_Nhan_vien.Click, AddressOf XL_Chon_Nhan_vien
...
#Region "Xử lý Biến cố"
    Sub XL_Chon_Dong_y(Th_Dong_y As Control, Bc As EventArgs)
        ...
        If Da_chon_Nhan_vien = False Then
        ...
        If Chuoi_loi = "" Then
            Chuoi_loi = Nghiep_vu.Kiem_tra_Cap_nhat_Nhan_vien(Nhan_vien)
            If Chuoi_loi = "" Then
        ...
        If Chuoi_loi = "" Then
            Th_Thong_bao.Text = "Đã cập nhật hồ sơ"
        Else
            Th_Thong_bao.Text = Chuoi_loi
        End If
    End Sub

    Sub XL_Chon_Nhan_vien(Th_Chon_Nhan_vien As Control, Bc As EventArgs)

        Dim Mh As New MH_Chon_Nhan_vien(Du_lieu)
        Mh.ShowDialog()

        Nhan_vien = Mh.Nhan_vien_Chon

        If Nhan_vien IsNot Nothing Then
            Da_chon_Nhan_vien = True
            Th_Thong_bao.Text = ""
