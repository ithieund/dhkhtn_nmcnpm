...
#Region "Biến/Đối tượng toàn cục"
    Dim Luu_tru As New XL_LUU_TRU(LOAI_CSDL.Acesss, "QLNV_2")
...
#Region "Xử lý Khởi động"
    ...
    Sub Khoi_dong()
        ...
        AddHandler TH_Tra_cuu_Nhan_vien_Theo_1_Ngoai_ngu.Click, AddressOf XL_Chon_Tra_cuu_Nhan_vien_Theo_1_Ngoai_ngu
    End Sub
#End Region
...
#Region "Xử lý Biến cố"
    ...
    Sub XL_Chon_Cap_nhat(Th_Cap_nhat As Control, Bc As EventArgs)
        Dim Mh As New MH_Cap_nhat_Nhan_vien(Du_lieu)
        Mh.ShowDialog()
    End Sub

    Sub XL_Chon_Thong_ke_So_luong_Nhan_vien_Theo_Don_vi(Th_Thong_ke_So_luong_Nhan_vien_Theo_Don_vi As Control, Bc As EventArgs)
        Dim Mh As New MH_Thong_ke_So_luong_Nhan_vien_Theo_Don_vi(Du_lieu)
        Mh.ShowDialog()
    End Sub

    Sub XL_Chon_Tra_cuu_Nhan_vien_Theo_1_Ngoai_ngu(TH_Tra_cuu_Nhan_vien_Theo_1_Ngoai_ngu As Control, Bc As EventArgs)
        Dim Mh As New MH_Tra_cuu_Nhan_vien_Theo_1_Ngoai_ngu(Du_lieu)
        Mh.ShowDialog()
    End Sub
#End Region
