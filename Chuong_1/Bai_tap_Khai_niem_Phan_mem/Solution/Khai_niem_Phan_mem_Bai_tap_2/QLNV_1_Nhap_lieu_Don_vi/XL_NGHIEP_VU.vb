...
#Region "Tiep nhan thong tin"
    Public Function Tao_Don_vi_Moi(Du_lieu As DataSet) As DataRow

        Dim Don_vi_Moi As DataRow = Du_lieu.Tables("DON_VI").NewRow
        Don_vi_Moi("Ten") = ""
    ...
    Public Function Kiem_tra_Ghi_moi_Don_vi(Don_vi As DataRow) As String
        ...
        Dim Ten As String = Don_vi("Ten").ToString.Trim
        Hop_le = Ten <> "" And Du_lieu.Tables("DON_VI").Select("Ten = '" & Ten & "'").Count = 0

        If Not Hop_le Then
            Kq &= "Tên đơn vị phải khác trống và là duy nhất"
        End If
