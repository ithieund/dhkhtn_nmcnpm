Public Class MH_Cap_nhat_Nhan_vien
    ...
    Sub Khoi_dong()
        ...
        ' Lay ra ngau nhien mot nhan vien de chinh sua
        Dim Bo_Phat_sinh As New Random
        Dim Chi_so As Integer = Bo_Phat_sinh.Next(0, Du_lieu.Tables("NHAN_VIEN").Rows.Count)
        Nhan_vien = Du_lieu.Tables("NHAN_VIEN").Rows(Chi_so)
