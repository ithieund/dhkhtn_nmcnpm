...
#Region "Tiep nhan thong tin"
    ...
    Public Function Kiem_tra_Cap_nhat_Don_vi(Don_vi As DataRow) As String
        ...
        ' Kiem tra ten don vi phai khac rong va la duy nhat
        Dim Ten As String = Don_vi("Ten")
        Hop_le = Ten <> "" And Du_lieu.Tables("DON_VI").Select("ID <> " & Don_vi("ID") & " AND Ten='" & Ten & "'").Count = 0

        If Not Hop_le Then
            Kq &= "Tên đơn vị phải khác trống và là duy nhất" & vbCrLf
        End If
